...
2. LINK : https://drive.google.com/file/d/1yIaI9Ndl1dIDdq8fLU3-7SlktDi84qVf/view?usp=sharing
...
4. **Record episodes** using the script located at `simulation/record_episodes.py`.
...
```
- after ./build.sh TODO: for panda_ik copy to /home/$user/.local/lib/python3.8/site-packages
